...
public class ServerParseSet {
    ...
    public static final int CHARACTER_SET_CLIENT = 8;       // 客户端使用的编码
    public static final int CHARACTER_SET_CONNECTION = 9;   // 连接使用的编码
    public static final int CHARACTER_SET_RESULTS = 10;     // 查询返回的结果集的编码
